...
Route::middleware('auth:sanctum')->post('/addparts',[MedicineController::class,'addparts']);
Route::middleware('auth:sanctum')->post('/giveparts',[MedicineController::class,'giveparts']);
Auth::routes();
